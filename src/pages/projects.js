...
const FeatureProject = ({ type, title, summary, img, github, link }) => {
  return (
    ...
    bg-light shadow-2xl p-12 relative dark:bg-dark dark:border-light lg:flex-col lg:p-8 xs:rounded-2xl xs:rounded-br-3xl xs:p-4"
    >
...
const projects = () => {
  return (
    <>
      <Head>
        <title>Akshita | Projects Page</title>
        <meta
          name="description"
          content="Explore a collection of diverse and innovative projects in my portfolio. From web development to graphic design, each project showcases my skills and creativity. Discover how I tackle challenges and deliver unique solutions in the world of design and technology."
        />
      </Head>
      <TransitionEffect />
          ...
          <div className="grid grid-cols-12 gap-24 gap-y-32 xl:gap-x-16 lg:gap-x-8 md:gap-y-24 sm:gap-x-0">
            <div className="col-span-12">
              <FeatureProject
                ...
                img={project1}
                summary="Crypto Screener Application A feature-rich Crypto Screener App
